...
A web-based sentiment analysis application built using Python and Streamlit. 
This project analyzes Twitter data (offline dataset) and classifies tweets into 
Positive, Negative, and Neutral categories using Natural Language Processing (NLP).

---

##  Project Overview

The Twitter Sentiment Analysis System helps in understanding public opinion by 
analyzing the emotional tone of tweets. It uses an offline dataset and TextBlob 
for sentiment classification and presents results through an interactive 
Streamlit dashboard.
